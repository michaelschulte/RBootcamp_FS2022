...
12. Um sicherzustellen, dass nicht wieder die selben Probleme auftreten, lese `diamonds_sauber.csv` wieder ein und schaue dir die Spaltennamen und die Spaltentypen an. Alles in Ordnung?
...
```{r}
# Lese titanic.xls
titanic <- read_excel(file = "1_Data/titanic.xls")
```
